...
const MessageBox: React.FC<MessageBoxProps> = ({
  ...
  .filter((user) => user.email !== data?.sender?.email) // needs to be seen by the users that not the currentUser
  .map((user) => user.name)
  .join(', '); 
    ...
    <div className={container}>
      ...
      <div className={body}>
        ...
        <div className={message}>
          <ImageModal src={data.image} isOpen={imageModelOpen} onClose={() => setImageModalOpen(false)}/>
          {data.image ? (
